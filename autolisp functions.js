///// AutoLISP Keyword List
window.AUTOLISP_KEYWORDS = [
/// from afralisp:
"*error*","+","-","*","/","=","/=","<","<=",">",">=","~","1+","1-",
"abs","and","angle","angtos","append","apply","ascii","assoc","atan","atof","atoi","atom",
"Boole","boundp",
"car","caar","cadar","cadr","caddr","cdr","cdar","cddr","chr","close","command","cond","cons","cos",
"defun","distance",
"entnext","entlast","entsel","entdel","entget","entmod","entupd","eq","equal","eval","exp","expt",
"findfile","fix","float","foreach",
"gcd","getangle","getcorner","getdist","getenv","getkword","getorient","getpoint","getreal","getstring","getvar","graphscr","grclear","grdraw","grtext","grread",
"if","inters","itoa",
"lambda","last","length","list","listp","load","log","logand","logior","lsh",
"mapcar","max","member","menucmd","min","minusp",
"not","nth","null","numberp",
"open","or","osnap",
"polar","prin1","princ","print","progn","prompt",
"quote",
"read","read-char","read-line","redraw","rem","repeat","reverse","rtos",
"set","setq","setvar","sin","sqrt","ssget","sslength","ssname","ssadd","ssdel","ssmemb","strcase","strcat","strlen","subst","substr",
"tblnext","tblsearch","terpri","textscr","trace","trans","type",
"untrace",
"ver","vmon","vports",
"while","write-char","write-line",
"zerop",
...
/// properties functions: "vla-get-*prop*","vla-set-*prop*"

// note: 
// "vlax-get-property obj '*prop*" ---> gives list not vla varient
// "vla-get-*prop* obj"            ---> gives vla-varient
